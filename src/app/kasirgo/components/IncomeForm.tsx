...
export const IncomeForm: React.FC<IncomeFormProps> = ({
  newDailyIncome, setNewDailyIncome, onAdd, formatInputNumber
}) => {
  return (
    <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 space-y-4">
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          <h3 className="font-black text-sm text-slate-800 uppercase tracking-tight">Catat Pemasukan Lain</h3>
          <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Contoh: Parkir, Titip Jual...</p>
        </div>
      </div>
